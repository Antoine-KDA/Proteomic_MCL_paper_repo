...
# sink(file = file.path(save_dir, "Simple_treeBagRFE_NoDupProt.Rout"), append = FALSE, type = "output")
...
for(s in 4:6){
  ...
  # Save the model
  treeBagRFE_NoDupProt_results_list <- results_list
  save(treeBagRFE_NoDupProt_results_list, rfe_ctrl, Prot_train_nodup, file = file.path(save_dir, paste0("treeBagRFE_NoDupProt_Filtered_NF_Size", nsize, "_station.Rdata")))
  
  # Transform - and Get the best tuning parameters in all models ----------------
  
  # load(file = file.path(save_dir, "treeBagRFE_NoDupProt_Filtered_NF_station.Rdata"))
  # results_list <- treeBagRFE_NoDupProt_results_list; rm(treeBagRFE_NoDupProt_results_list, rfe_ctrl, Prot_train_nodup)
  ...
  VarPlot
  ggsave(VarPlot, file = file.path(save_dir, paste0("treeBagRFE_NoDupProt_Filtered_NF_Size", nsize, "_Variables.png")), units = "cm", 
         height = 20, width = 15)
  ...
  png(file = file.path(save_dir, paste0("treeBagRFE_NoDupProt_Filtered_NF_Size", nsize, "_MaxRocTrain.png")), units = "cm", 
  ...
  rio::export(PerfBestModel_on_train, file = file.path(save_dir, paste0("treeBagRFE_NoDupProt_Filtered_NF_Size", nsize, "_PerfBestModel_on_train.xlsx")))
  ...
  png(file = file.path(save_dir, paste0("treeBagRFE_NoDupProt_Filtered_NF_Size", nsize, "_ROC_Curve_on_test.png")), units = "cm", 
  ...
  rio::export(perfexport_test, file = file.path(save_dir, paste0("treeBagRFE_NoDupProt_Filtered_NF_Size", nsize, "_perfomance_on_test.xlsx")))
  rio::export(bestpredictors, file = file.path(save_dir, paste0("treeBagRFE_NoDupProt_Filtered_NF_Size", nsize, "_bestpredictors.xlsx")))
  ...
  rm(Accuracy_test, auc_value, modAuc_test, n, namtoplot, pred_numeric, 
     table_grob, roc_curve, treeBagRFE_NoDupProt_results_list, results_list, 
