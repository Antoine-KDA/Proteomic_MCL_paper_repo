...
for(s in 4:6){
  ...
  save(RFrfe_results_list, rfe_ctrl, trainlist, file = file.path(save_dir, paste0("RFrfe_Filtered_NF_Size", nsize, "_station.Rdata")))
  
  # Transform - and Get the best tuning parameters in all models ----------------
  
  # load(file = file.path(save_dir, "RFrfe_Filtered_NF_station.Rdata"))
  # results_list <- RFrfe_results_list; rm(RFrfe_results_list, rfe_ctrl, trainlist)
  ...
  ggsave(VarPlot, 
         file = file.path(save_dir, paste0("RFrfe_Filtered_NF_Size", nsize, "_Variables.png")), 
  ...
  png(file = file.path(save_dir, paste0("RFrfe_Filtered_NF_Size", nsize, "_MaxRocTrain.png")), units = "cm", 
  ...
  rio::export(PerfBestModel_on_train, file = file.path(save_dir, paste0("RFrfe_Filtered_NF_Size", nsize, "_PerfBestModel_on_train.xlsx")))
  ...
  png(file = file.path(save_dir, paste0("RFrfe_Filtered_NF_Size", nsize, "_ROC_Curve_on_test.png")), units = "cm", 
  ...
  rio::export(perfexport_test, file = file.path(save_dir, paste0("RFrfe_Filtered_NF_Size", nsize, "_perfomance_on_test.xlsx")))
  rio::export(bestpredictors, file = file.path(save_dir, paste0("RFrfe_Filtered_NF_Size", nsize, "_bestpredictors.xlsx")))
